...
const Navbar = () => {
  ...
  return (
    <Stack direction="row" justifyContent="flex-start" alignItems="center" sx={{ px: '20px', mt: { sm: '32px', xs: '20px' } }}>
      <NavLink to="/" exact>
      ...
      <NavLink to="/user-profile" style={{ marginLeft: 'auto' }}>
        <img src={ProfileIcon} alt="User Profile" style={{ width: '48px', height: '48px', borderRadius: '50%' }} />
      </NavLink>
    </Stack>
  );
};
