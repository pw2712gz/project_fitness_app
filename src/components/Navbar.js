...
const Navbar = () => {
    ...
    return (
        <Stack direction="row" justifyContent="flex-start" alignItems="center"
               sx={{px: '20px', mt: {sm: '32px', xs: '20px', backgroundColor: '#FFE5E5'}}}>
            <NavLink to="/" exact>
            ...
            <Stack direction="row" gap="20px" fontFamily="Alegreya" fontSize="24px" alignItems="flex-end" flexGrow={1}>
                ...
                <NavLink to="/ai-coach" style={({isActive}) => (isActive ? activeStyle : defaultStyle)}>AI
                    Coach</NavLink>
                <NavLink to="/calendar"
                         style={({isActive}) => (isActive ? activeStyle : defaultStyle)}>Calendar</NavLink>
                <NavLink to="/BmiCalculator" style={({isActive}) => (isActive ? activeStyle : defaultStyle)}>BMI
                    Calculator</NavLink>
            </Stack>
