...
const HeroBanner = () => (
  <Box sx={{ mt: { lg: '12px', xs: '6px' }, ml: { sm: '50px' } }} position="relative" p="20px">
    ...
    <Stack mb="50px">
      ...
      <a href="/ai-coach" style={{ marginTop: '45px', textDecoration: 'none', width: '200px', textAlign: 'center', background: '#FF2625', padding: '14px', fontSize: '22px', textTransform: 'none', color: 'white', borderRadius: '4px' }}>Meet Your AI Coach</a>
    </Stack>
