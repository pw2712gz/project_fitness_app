        ...
        <Box sx={{
            ...
            <Paper elevation={3} sx={{
                ...
                <Stack direction="row" spacing={1}
                       sx={{p: 1, bgcolor: 'background.paper', borderTop: '1px solid rgba(0,0,0,.12)'}}>
                    <TextField fullWidth label="Ask your AI Coach" value={userInput} onChange={handleInputChange}
                               variant="outlined" onKeyDown={(event) => event.key === 'Enter' && handleSubmit()}
                               size="small" placeholder="Type your question here..."/>
